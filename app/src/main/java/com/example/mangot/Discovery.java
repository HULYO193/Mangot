        ...
        db.collection("mangot").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    RecyclerView.LayoutManager layoutManager = new GridLayoutManager(Discovery.this, 2, RecyclerView.VERTICAL, true);
                    recyclerdiscovery.setLayoutManager(layoutManager);

                    DiscoveryAdapter discoveryadapter = new DiscoveryAdapter(discoveryManga);
